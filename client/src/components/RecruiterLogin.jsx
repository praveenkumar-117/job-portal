...
const RecruiterLogin = () => {
  ...
  return (
    <div className='absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex  justify-center items-center'>
      <form onSubmit={onSubmiteform} className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        {state === 'Login' ? <p className='text-sm text-blue-600 my-4 cursor-pointer'>forget password</p> : <div className='py-4'> </div>}


        <button type='submit' className='bg-blue-600 w-full px-4 py-2 rounded-full text-white hover:bg-blue-800 hover:font-semibold'>
          {state === 'Login' ? 'login' : isTxtDataSubmited ? 'Create Account' : 'Next'}
        </button>
