  ...
  return (
    <div className="container 2xl:px-20 mx-auto my-10">
      ...
      <div className="bg-gray-200 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 shadow-sm mx-2 mt-5 p-6 rounded-xl">
        {/* Trusted By heading ko alag rakhkar company logos ko mobile par 2-column grid me arrange karne ke liye */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 lg:gap-16">
          <p className="font-semibold text-gray-800 dark:text-gray-200">
            Trusted By
          </p>

           <div className="grid grid-cols-2 md:flex md:items-center md:justify-center gap-6 md:gap-10 lg:gap-16">
            <img
