...
<div className='relative bg-gray-200 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-6 sm:p-12 lg:p-32 rounded-2xl shadow-sm'>
        <div >
       <h1 className='text-2xl sm:text-4xl font-bold mb-8 max-w-md text-center sm:text-left text-gray-900 dark:text-white'>
